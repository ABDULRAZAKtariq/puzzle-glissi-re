...
public class Piece extends AbstractModeleEcoutable {
    ...
    /**
     * Constructeur de la classe Piece avec l'identifiant, la position initiale et la position finale .
     * 
     * @param id L'identifiant de la pièce.
     * @param posInit La position initiale de la pièce.
     * @param posFinal La position finale de la pièce.
     */
    ...
    public void setEstTrou(boolean est_trou) {
        this.estTrou = est_trou;
    }

    /**
    * Redéfinition de la méthode toString pour obtenir une représentation textuelle de la pièce.

...
public class GrillePanel extends JPanel implements MouseListener, MouseMotionListener , EcouteurModele{
    ...
    /**
     * Constructeur de la classe GrillePanel avec la fenêtre parente et la grille de jeu spécifiées.
     * @param frameParent La fenêtre principale parente.
    ...
    /**
     * Méthode invoquée lorsqu'un événement de modèle est mis à jour, tel que la grille de jeu.
     * @param source La source de l'événement de modèle mis à jour.
     */
    @Override
    ...
    /**
     * Méthode pour redémarrer le jeu en mélangeant la grille.
     * @ensures Le jeu est redémarré avec une grille mélangée et le nombre de coups est réinitialisé.
     */
    public void restart(){
        if(grille.jeuTerminee()){
            grille.getTab()[grille.getLargeur()-1][grille.getHauteur()-1].setEstTrou(true);
            }
    ...
    /**
    * Méthode pour récupérer la grille de jeu.
    */
